...
const PLANNER_SYSTEM_INSTRUCTION = [
  ...
  "- NUORODA Į ANKSTESNĮ OBJEKTĄ: kai vartotojas nurodo ankstesnį objektą / aptartas sąlygas („pagal aptartas sąlygas“, „tuos“, „tokius“, „juos“), IŠSPRĘSK objektą, kategoriją ir kainos rėžius iš factsBlock + istorijos ir perduok searchListings args (category, maxPrice) — tai yra catalog_search pagal aptartą temą, NE browse-all ir NE tuščias query.",
