...
- Jei search_empty — pasiūlyk pagalbą, patikslink filtrus (applyBrowseFilter) arba searchListings su išplėstu query.
- Klaidingai ištartus ar trumpus žodžius Spintos režime koreguok intuityviai (batai, suknelė, dydis, spalva).`;
}
