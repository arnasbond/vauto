/**
 * Canonical browse-all + listing-confirmation intents.
 * Single source for Next.js (@vauto/shared/intents/*) and Express (server/src/shared/intents).
 */

import { isUltraShortConfirmation } from "../chaotic-input.js";
