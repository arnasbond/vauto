...
Autonomija: ištrauk geriausią paieškos intenciją iš vaizdo. Jei silpna — sumažink confidence, BET VIS TIEK grąžink cleanQuery / searchFilters. DRAUDŽIAMA „Prekė neatpažinta“ kaip stop.
${input.wardrobeOnly ? SPINTA_SEARCH_SYSTEM_RULE : ""}
