...
Jei matomas visas automobilis (Citroën, Peugeot, BMW, VW, Toyota ir kt.) — category "vehicles", title su make+model, attributes: make, model, year, fuelType, bodyType.
Kėbulo / modelio ORIENTYRAI (rekomendacija, ne suvaržymas): siluetas (hečbekas / universalas / sedanas / vienatūris), D-stulpelis, stogo rilingai, langų eilės, žibintų forma — naudok tik jei AIŠKIAI matai; OCR D.3 turi prioritetą.
