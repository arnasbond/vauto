      ...
      <div className="flex-1 space-y-3 overflow-y-auto pb-4">
        ...
        {listing?.id ? (
          <Link
            ...
            className="mx-2 mb-2 inline-flex items-center justify-center rounded-2xl border border-[var(--ds-brand)]/30 bg-[var(--ds-brand-soft,#ecfdf5)] px-4 py-2.5 text-sm font-semibold text-[var(--ds-brand)]"
            data-open-deal-room
          >
