      ...
      <div
        className={
          embedded
            ...
            : "listing-wizard-overlay chameleon-wizard-shell flex items-center justify-center bg-[#0a1128] text-white min-h-screen p-4"
        }
      >
        <ZeroUiPaymentGate
          embedded
    ...
    <div
      className={
        embedded
          ...
          : "listing-wizard-overlay chameleon-wizard-shell bg-[#0a1128] text-white min-h-screen"
      }
    >
      <div
        className={
