...
export function AgentChatBubble({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "agent-chat-bubble max-w-[min(100%,22rem)] break-words rounded-2xl px-3.5 py-2.5 text-[13px] leading-relaxed [overflow-wrap:anywhere] md:max-w-[min(100%,40rem)] md:text-[14px] lg:max-w-[min(100%,46rem)]",
          isUser
