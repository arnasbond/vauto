/**
 * Canonical promote / visibility catalog — single source for client + server.
 * Keep server/src/shared/promote-catalog.ts in sync with this file.
 */
...
/** Soft additive boost inside organic score (used instead of hard TOP wall). */
...
/**
 * B2C / pre-publish product → plan tier.
 * Feed badge: tier 1 = PLUS, tier >= 2 = TOP.
 * (Previously B2C "top" wrongly mapped to tier 5 / 90-day MAX.)
 */
...
/** Seller trust contribution — requires ≥3 reviews. Max ~0.08. */
